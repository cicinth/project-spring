package com.revisao.banco.revisaoBanco.config;

import com.revisao.banco.revisaoBanco.exceptions.ErroValidacao;
...
public class ErrorHandler {
    ...
    public List<ErroValidacao> handler(MethodArgumentNotValidException exception){
        log.error("erro de validaco de campos");
        ...
        fieldErrors.forEach(e -> {
            ...
            ErroValidacao erroValidacao = new ErroValidacao(e.getField(), mensagemErro);
